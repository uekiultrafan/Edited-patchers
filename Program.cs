...
public class Program
{
    ...
    public static void RunPatch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state)
    {
        ...
        var soulGemPetty = state.LinkCache.Resolve<ISoulGemGetter>("SoulGemPettyFilled").ToNullableLink();
        var soulGemLesser = state.LinkCache.Resolve<ISoulGemGetter>("SoulGemLesserFilled").ToNullableLink();
        ...
        if (_settings.Value.PatchFullLoadOrder)
            ...
            foreach (var soulgem in state.LoadOrder.PriorityOrder.SoulGem().WinningOverrides())
            {
                ...
                {
                    "SoulGemPetty" => 10,
                    "SoulGemPettyFilled" => 40,
                    "SoulGemLesser" => 30,
                    "SoulGemLesserFilled" => 90,
                    "SoulGemCommon" => 45,
